...
def extract_index_features(dataset: Union[FashionIQDataset], clip_model) -> \
...
def extract_index_blip_features(dataset: Union[FashionIQDataset], blip_model, save_memory=False) -> \
        Tuple[torch.tensor, List[str]]:
    """
    Extract FashionIQ or CIRR index features
    :param dataset: FashionIQ or CIRR dataset in 'classic' mode
...
def extract_index_fuse_features(dataset: Union[FashionIQDataset], fuse_model) -> \
        Tuple[torch.tensor, List[str]]:
    """
    Extract FashionIQ or CIRR index features
    :param dataset: FashionIQ or CIRR dataset in 'classic' mode
