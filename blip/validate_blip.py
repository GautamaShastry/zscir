...
def compute_cirr_val_metrics(relative_val_dataset, blip_model, index_features,
...
def compute_cirr_val_metrics_relative(relative_val_dataset, clip_model, index_features: torch.tensor,
...
def generate_cirr_val_predictions(blip_model, relative_val_dataset, 
...
def generate_cirr_val_predictions_relative(clip_model , relative_val_dataset,
